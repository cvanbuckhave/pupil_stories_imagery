...
def dist_checks_wilcox(dm, suptype):
    ...
    print(f"Effort: {wilcoxon(dm_sub.response_effort[dm_sub.type == 'light'], dm_sub.response_effort[dm_sub.type == 'dark'])}")
    print(dm_sub.response_effort[dm_sub.type == 'light'].mean, dm_sub.response_effort[dm_sub.type == 'dark'].mean)
    print(dm_sub.response_effort[dm_sub.type == 'light'].std, dm_sub.response_effort[dm_sub.type == 'dark'].std)

    print(f"Arousal: {wilcoxon(dm_sub.emotional_intensity[dm_sub.type == 'light'], dm_sub.emotional_intensity[dm_sub.type == 'dark'])}")
    print(dm_sub.emotional_intensity[dm_sub.type == 'light'].mean, dm_sub.emotional_intensity[dm_sub.type == 'dark'].mean)
    print(dm_sub.emotional_intensity[dm_sub.type == 'light'].std, dm_sub.emotional_intensity[dm_sub.type == 'dark'].std)
    
    print(f"Presentation order: {wilcoxon(dm_sub.mean_pupil[dm_sub.order == 'second'], dm_sub.mean_pupil[dm_sub.order == 'first'])}")
